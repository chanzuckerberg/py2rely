...
def polisher(
    ...
    for ii in range(num_iterations):
        ...
        utils.post_process_job.joboptions['mask'].value = mask
        ...
        # New Alignments Come Out of Here...

        # Bayesian Polishing
        utils.bayesian_polish_job.joboptions['in_tomgorams'].value = utils.ctf_refine_job.output_dir + 'tomograms.star'
        ...
        # Should I refine + Post-Process Again? 
